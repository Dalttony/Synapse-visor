...
public class Model implements Closeable {
    ...
    public Pair run(ByteBuffer inputTensor) {
        ...
        Postprocessor.Result rs  = Postprocessor.bestFromProbabilities(output[0], labels);
        Log.e("MAINACTIVIY_",rs.getLabel()+ " "+rs.getConfidence());
        return new Pair(rs.getLabel(), rs.getConfidence());
